# Run from the repository root with pinned dependencies and the saved baseline.
# Reads archived decisions; does not rewrite outputs, labels or live decisions.
for (f in list.files("R", pattern = "[.]R$", full.names = TRUE)) source(f)
packet <- "data/validation/museum_address_review_2026-09-15"
...
print(expected)
message("Archived counts, original fields, unaffected records and protected files reproduced.")
